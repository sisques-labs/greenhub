import { PlantSpeciesCategory } from '../api/types/plant-species.types';

export const PLANT_SPECIES_CATEGORIES: Record<
	PlantSpeciesCategory,
	{ label: string; icon: string; color: string }
> = {
	[PlantSpeciesCategory.VEGETABLE]: { label: 'Vegetable', icon: '🥕', color: 'green' },
	...
	[PlantSpeciesCategory.SUCCULENT]: { label: 'Succulent', icon: '🌵', color: 'teal' },
