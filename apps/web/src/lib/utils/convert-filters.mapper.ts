import type { Filter } from "@/lib/types/entities/criteria";
import { FilterOperator } from "@/lib/types/enums/filter-operator.enum";
import type { DynamicFilter } from "@/ui/composites/table-layout";
