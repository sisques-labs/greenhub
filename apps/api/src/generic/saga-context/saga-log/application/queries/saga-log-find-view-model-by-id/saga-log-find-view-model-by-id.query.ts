import { ISagaLogFindViewModelByIdQueryDto } from "@/generic/saga-context/saga-log/application/dtos/queries/saga-log-find-view-model-by-id/saga-log-find-view-model-by-id.dto";
