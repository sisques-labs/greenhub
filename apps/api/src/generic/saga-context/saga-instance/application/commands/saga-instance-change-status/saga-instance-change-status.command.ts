import { ISagaInstanceChangeStatusCommandDto } from "@/generic/saga-context/saga-instance/application/dtos/commands/saga-instance-change-status/saga-instance-change-status-command.dto";
