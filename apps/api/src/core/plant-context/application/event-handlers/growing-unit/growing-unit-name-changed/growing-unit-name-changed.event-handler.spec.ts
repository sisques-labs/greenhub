...
describe('GrowingUnitNameChangedEventHandler', () => {
  let handler: GrowingUnitNameChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitNameChangedEventHandler>(
      GrowingUnitNameChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when name is changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitNameChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitNameChangedEvent',
        },
        {
          id: growingUnitId,
          oldValue: 'Garden Bed 1',
          newValue: 'Garden Bed 2',
        },
      );
