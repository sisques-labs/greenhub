...
describe('GrowingUnitTypeChangedEventHandler', () => {
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitTypeChangedEventHandler>(
      GrowingUnitTypeChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when type is changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitTypeChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitTypeChangedEvent',
        },
        {
          id: growingUnitId,
          oldValue: GrowingUnitTypeEnum.GARDEN_BED,
          newValue: GrowingUnitTypeEnum.POT,
        },
      );
