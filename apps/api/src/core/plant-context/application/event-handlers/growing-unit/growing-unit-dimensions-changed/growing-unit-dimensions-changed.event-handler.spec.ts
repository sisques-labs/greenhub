...
describe('GrowingUnitDimensionsChangedEventHandler', () => {
  let handler: GrowingUnitDimensionsChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitDimensionsChangedEventHandler>(
      GrowingUnitDimensionsChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when dimensions are changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitDimensionsChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitDimensionsChangedEvent',
        },
        {
          id: growingUnitId,
          oldValue: null,
