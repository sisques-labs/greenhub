...
describe('GrowingUnitCapacityChangedEventHandler', () => {
  let handler: GrowingUnitCapacityChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitCapacityChangedEventHandler>(
      GrowingUnitCapacityChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when capacity is changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitCapacityChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitCapacityChangedEvent',
        },
        {
          id: growingUnitId,
          oldValue: 10,
      ...
      const mockGrowingUnit = new GrowingUnitAggregate(
        {
          ...
          capacity: new GrowingUnitCapacityValueObject(20),
          dimensions: null,
          plants: [],
        },
        false,
