...
describe('GrowingUnitPlantNotesChangedEventHandler', () => {
  let handler: GrowingUnitPlantNotesChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitPlantNotesChangedEventHandler>(
      GrowingUnitPlantNotesChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when plant notes are changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitPlantNotesChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitPlantNotesChangedEvent',
        },
        {
          id: '223e4567-e89b-12d3-a456-426614174000',
          oldValue: null,
          newValue: 'Keep in indirect sunlight',
        },
      );
