...
describe('GrowingUnitPlantNameChangedEventHandler', () => {
  let handler: GrowingUnitPlantNameChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitPlantNameChangedEventHandler>(
      GrowingUnitPlantNameChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when plant name is changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitPlantNameChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitPlantNameChangedEvent',
        },
        {
          id: '223e4567-e89b-12d3-a456-426614174000',
          oldValue: 'Basil',
          newValue: 'Sweet Basil',
        },
      );
