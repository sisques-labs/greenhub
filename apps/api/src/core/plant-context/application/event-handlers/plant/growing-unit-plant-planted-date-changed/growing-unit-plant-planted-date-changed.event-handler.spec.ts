...
describe('GrowingUnitPlantPlantedDateChangedEventHandler', () => {
  let handler: GrowingUnitPlantPlantedDateChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitPlantPlantedDateChangedEventHandler>(
      GrowingUnitPlantPlantedDateChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when plant planted date is changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitPlantPlantedDateChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitPlantPlantedDateChangedEvent',
        },
        {
