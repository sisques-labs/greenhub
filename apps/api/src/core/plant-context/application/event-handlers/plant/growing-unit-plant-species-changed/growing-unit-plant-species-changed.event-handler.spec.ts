...
describe('GrowingUnitPlantSpeciesChangedEventHandler', () => {
  let handler: GrowingUnitPlantSpeciesChangedEventHandler;
  ...
  beforeEach(async () => {
    ...
    handler = module.get<GrowingUnitPlantSpeciesChangedEventHandler>(
      GrowingUnitPlantSpeciesChangedEventHandler,
    );
  });
  ...
  describe('handle', () => {
    it('should update growing unit view model when plant species is changed', async () => {
      const growingUnitId = '123e4567-e89b-12d3-a456-426614174000';
      const event = new GrowingUnitPlantSpeciesChangedEvent(
        {
          aggregateId: growingUnitId,
          aggregateType: 'GrowingUnitAggregate',
          eventType: 'GrowingUnitPlantSpeciesChangedEvent',
        },
        {
          id: '223e4567-e89b-12d3-a456-426614174000',
          oldValue: 'Ocimum basilicum',
          newValue: 'Ocimum basilicum var. minimum',
        },
      );
